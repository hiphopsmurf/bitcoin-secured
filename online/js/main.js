...
(function() {
  var AlertCtrl, AppController, DialogCtrl, DownloadCtrl, FormCtrl, HomeCtrl, ModalCtrl, RegisterCtrl, SubmitCtrl, app;
  ...
  app.controller("HomeCtrl", HomeCtrl = function($scope) {
    return $scope.home = {};
  });
